      ...
      <div class="four wide column">
        ...
        <div class="twelve wide column">
          <div class="ui segment">
            <div class="ui top attached label"><?php echo $user->username ?>的问题  </div>
            <div class="floating ui teal label"><?php echo count($questions) ?></div>
            <div class="ui bottom right attached label"><a href="<?php echo site_url("/user/more_question/".$user->id);?>">更多</a></div>
            ...
            <?php if (isset($questions)): ?>
            	...
            	<?php for ($i=0; $i < 5 && $i < $count; $i++) { ?>
				  <div class="item">
				    ...
				    <div class="content">
				      <a class="header" href="<?php echo site_url("question/view_detail/".$questions[$i]->id);?>"><?php echo $questions[$i]->title ?></a>
				      <div class="description"><?php echo $questions[$i]->content ?></div>
				    </div>
				  </div>
				<?php } ?>
            <?php endif ?>
          ...
          <div class="ui segment">
            ...
            <div class="floating ui teal label"><?php echo count($replys) ?></div>
             <div class="ui bottom right attached label"><a href="<?php echo site_url("/user/more_reply/".$user->id);?>">更多</a></div>
	            <div class="ui home list">
	            <?php if (isset($replys)): ?>
